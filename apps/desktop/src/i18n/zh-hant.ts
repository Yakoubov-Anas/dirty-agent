...
export const zhHant = defineLocale({
  ...
  git: {
    ...
    unstageAll: '全部取消暫存',
    commit: '提交',
    messagePlaceholder: '提交訊息',
    branchWidgetTitle: '目前分支 — 開啟提交',
    searchPlaceholder: '搜尋分支和動作',
    updateProject: '更新專案…',
    push: '推送…',
    newBranch: '新增分支…',
    newBranchName: '分支名稱',
    ...
    noBranches: '找不到分支。',
    checkout: '檢出',
    newBranchFrom: name => `從 '${name}' 新增分支…`,
    mergeInto: (from, into) => `將 '${from}' 合併到 '${into}'`,
    rebaseOnto: (current, target) => `將 '${current}' 變基到 '${target}'`,
    rename: '重新命名…',
    delete: '刪除',
    renameTitle: name => `重新命名分支 '${name}'`,
    deleteConfirm: name => `刪除分支 '${name}'？`,
    cancel: '取消',
    binaryFile: '二進位檔案 — 無法預覽。',
    compareWith: name => `與 '${name}' 比較`,
    showDiffWorkingTree: '顯示與工作樹的差異',
    ...
    ahead: count => `領先 ${count} 個提交`,
    behind: count => `落後 ${count} 個提交`
  },

  database: {
    aria: '資料庫',
    title: '資料庫',
    empty: '尚無資料庫。開啟一個 SQLite 檔案開始使用。',
    addConnection: '開啟資料庫',
    removeConnection: '移除連線',
    refreshSchema: '重新整理結構描述',
    selectConnection: '選擇資料庫',
    openDatabase: '開啟 SQLite 資料庫',
    noTables: '沒有資料表。',
    newConsole: '新增 SQL 主控台',
    openData: '開啟資料',
    rowRange: (start, end) => `${start}–${end}`,
    prevPage: '上一頁',
    nextPage: '下一頁',
    queryPlaceholder: '撰寫 SQL — ⌘/Ctrl+Enter 執行',
    run: '執行',
    runShortcut: '⌘/Ctrl+Enter 執行游標處的陳述式',
    runHint: '執行查詢或開啟資料表以檢視結果。',
    truncated: '已截斷',
    filterResults: '篩選結果…',
    export: '匯出',
    exportCsv: '匯出 CSV',
    ...
    testConnection: '測試連線',
    testOk: '連線成功',
    connectionFailed: '無法新增連線。',
    driverMissing: pkg => `未安裝驅動程式 '${pkg}'。`,
    installDriver: '安裝',
    installingDriver: '正在安裝驅動程式…',
    file: '檔案',
    openTable: name => `開啟 ${name}`,
