...
export const ja = defineLocale({
  ...
  database: {
    aria: 'データベース',
    title: 'データベース',
    empty: 'データベースがありません。SQLite ファイルを開いて始めましょう。',
    addConnection: 'データベースを開く',
    removeConnection: '接続を削除',
    refreshSchema: 'スキーマを更新',
    selectConnection: 'データベースを選択',
    openDatabase: 'SQLite データベースを開く',
    noTables: 'テーブルがありません。',
    newConsole: '新しい SQL コンソール',
    openData: 'データを開く',
    rowRange: (start, end) => `${start}–${end}`,
    prevPage: '前のページ',
    nextPage: '次のページ',
    queryPlaceholder: 'SQL を入力 — ⌘/Ctrl+Enter で実行',
    run: '実行',
    runShortcut: '⌘/Ctrl+Enter でカーソル位置の文を実行',
    runHint: 'クエリを実行するかテーブルを開くと結果が表示されます。',
    truncated: '切り捨て',
    filterResults: '結果を絞り込む…',
    export: 'エクスポート',
    ...
    host: 'ホスト',
    port: 'ポート',
    databaseField: 'データベース',
    user: 'ユーザー',
    password: 'パスワード',
    testConnection: '接続をテスト',
    testOk: '接続に成功しました',
    connectionFailed: '接続を追加できませんでした。',
    driverMissing: pkg => `ドライバー '${pkg}' がインストールされていません。`,
    installDriver: 'インストール',
    installingDriver: 'ドライバーをインストール中…',
    file: 'ファイル',
    openTable: name => `${name} を開く`,
