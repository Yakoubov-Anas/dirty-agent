...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  createEntry: (parentPath, name, kind) => ipcRenderer.invoke('hermes:fs:create', parentPath, name, kind),
  renameEntry: (sourcePath, newName) => ipcRenderer.invoke('hermes:fs:rename', sourcePath, newName),
  deleteEntry: targetPath => ipcRenderer.invoke('hermes:fs:delete', targetPath),
  selectPaths: options => ipcRenderer.invoke('hermes:selectPaths', options),
  writeClipboard: text => ipcRenderer.invoke('hermes:writeClipboard', text),
  saveImageFromUrl: url => ipcRenderer.invoke('hermes:saveImageFromUrl', url),
  saveImageBuffer: (data, ext) => ipcRenderer.invoke('hermes:saveImageBuffer', { data, ext }),
  captureWebContents: (id, rect) => ipcRenderer.invoke('hermes:browser:capture', { id, rect }),
